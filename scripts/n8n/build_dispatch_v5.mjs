...
const body = {
  ...
  nodes: [
    ...
    // d5: 呼叫對應子 webhook（Code 節點，rawContentType body expression 不執行的已知 bug）
    { id: 'd5', name: '呼叫對應 baton', type: 'n8n-nodes-base.code', typeVersion: 2, position: [1360, 300],
      parameters: {
        language: 'javaScript',
        jsCode: `
const pageId = $json.pageId;
const mode = $json.mode;
const modeKey = $json.modeKey;
...
`.trim()
    ...
    // d6: PATCH 外掛狀態=完成（$helpers.httpRequest — task runner 沙箱唯一可用的 HTTP 方法）
