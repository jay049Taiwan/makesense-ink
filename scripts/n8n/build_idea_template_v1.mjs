...
// v2 fix: n5 URL data_sources→databases, n5+n10 改 Code 節點 this.helpers.httpRequest
...
const DB05_ID = '28a667a9-ede1-466a-9f18-419da33a8810';
...
const resp = await this.helpers.httpRequest({
  method: 'POST',
  url: 'https://api.notion.com/v1/databases/${DB05_ID}/query',
  headers: {
  ...
  body: {
    filter: { and: [
      { property: '文案選項', select: { equals: ext.wenanOption } },
      { property: '發佈狀態', status: { equals: '已發佈' } }
    ]},
...
const body = {
  ...
  nodes: [
    ...
    { id: 'n5', name: '查 DB05 候選', type: 'n8n-nodes-base.code', typeVersion: 2, position: [1200, 300],
      parameters: { language: 'javaScript', jsCode: queryDB05Code } },
    ...
    { id: 'n10', name: '更新執行備註', type: 'n8n-nodes-base.code', typeVersion: 2, position: [2400, 300],
      parameters: { language: 'javaScript', jsCode: patchNoteCode } }
  ],
  connections: {
