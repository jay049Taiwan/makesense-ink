...
⬅️ **下一個 Session 從 DB01 Phase 2 開始**（722f2478-7e61-4b4b-ad1c-d171b4a639db）。

**DB01 要加：時間進度 + 社群×5 = 6 條**（無財務類）
- 日期欄位名：fetch schema 確認（DB01 可能叫「提案起算」「提案截止」等）
- relation 到 DB06：grep `明細` 確認
