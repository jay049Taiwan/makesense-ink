...
⬅️ **下一個 Session 從 DB05 Phase 2 開始**（28a667a9-ede1-466a-9f18-419da33a8810）。

**DB05 要加：社群×5 + 財務A×6 = 11 條**（無時間進度/金額狀態）
- DB05 relation 名確認：fetch schema grep `明細`
- 財務公式同 DB03/DB04（收入總計-based）
