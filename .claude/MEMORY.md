...
- [hihicheck_quality_design.md](memory/hihicheck_quality_design.md) — ⚠️ 退回次數 KPI 已棄用（2026/05/22）→ 改用「被引總數」formula（9 個被引 relation 加總，8 DB 已加）驅動 hihigm 對標參考傳播；黃金範例＝通過審查＋被引高（檔末更新段為現況，上半部 KPI 為歷史脈絡）
