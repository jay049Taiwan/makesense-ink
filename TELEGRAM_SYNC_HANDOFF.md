...
| **交接** | 📋 | 待辦事項列表，左欄 DB03 項目、右欄 DB06 進銷明細子任務 | DB03 + DB06 |
| **庫存** | 📦 | 商品庫存數量管理 | DB07 庫存控管 |
| **紀錄** | 📓 | 打卡/日誌/請假/加班（DB05 紀錄備項 + Supabase staff_activities） | DB05 登記表單 |
| **費用** | 💰 | 請款 + 請購 | DB05 登記表單（請款請購） |
...
| DB05 | 登記表單 | `e5f14f056c7c4b8a804304eab598fd4d` | `28a667a9-ede1-466a-9f18-419da33a8810` |
