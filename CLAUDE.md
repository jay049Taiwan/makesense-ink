...
- Supabase 篩選：`.or("category.eq.商品/選書,category.eq.商品/選物,category.eq.商品/數位")`
- 適用位置：fetchSBProducts、搜尋 API、推薦區「你可能也會喜歡」
- 不適用：商品單品頁（用 notion_id 直接查）、Dashboard 管理頁面
