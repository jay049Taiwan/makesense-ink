...
仍用 mock data 或 placeholder 的頁面：
- /checkout — demo items（購物車空時注入的假資料，開發測試用）
- /viewpoint-stroll — 觀點列表用硬編碼 mock data，待改接 fetchSBTopics
- /product/[slug] — 商品單頁 placeholder，待建真實資料查詢
- /viewpoint/[slug] — 觀點單頁 placeholder，待建真實資料查詢
