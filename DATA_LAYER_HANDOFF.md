...
> **2026/05/08 補**：DB05 再新增 9 個 X被引 relation（提案被引/管考被引/項目被引/協作被引/內容被引/明細被引/庫存被引/對象被引/日期被引），語意「此 page 被他人引用」（入向）。**主要由 AI（嗨嗨聯想/Notion AI）廣泛寫入**，人工清掉不合適者；**不**走 Notion auto dual sync。
